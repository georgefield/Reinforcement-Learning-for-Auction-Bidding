...
class Auctioneer(object):
    ...
    def __init__(
        self,
        room=[Q_flat_bot_10, Q_random_bot],  # List of bots to play in the game
    ...
    def __initialise_bots(self):
        ...
        count = 0
        for bot_instance in self.room: #*** changed
            if self.verbose:
                print("Initialising {}".format(bot_instance))
            count += 1
            ...
            try:
                bot_unique_id = bot_instance.name+"-"+str(count)
    ...
    def run_auction(self):
        while not self.finished:
            ...
            # Check not all budget 0
            self.__check_not_all_budget_0()
        ...
        return self.allBroke, self.bots
    ...
    def __check_not_all_budget_0(self):
        for bot in self.bots:
            if (bot['budget'] > 0):
                return
        
        print('Broke bots detected')
        # All bots have no money theyre all trash and round is stopped and everyone goes home
        self.allBroke = True
        self.finished = True
...
if __name__ == "__main__":
    ...
    room = [Q_random_bot, Q_flat_bot_10]
